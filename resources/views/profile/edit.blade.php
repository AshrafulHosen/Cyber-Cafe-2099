...
@section('content')
    <div class="full-section">
        <section style="padding-top: 130px; max-width: 800px; margin: 0 auto;">
            ...
            <a href="{{ route('profile') }}" style="color: var(--text-dim); font-size: 0.85rem; text-decoration: none;">←
                Return to Dossier</a>
                    ...
                    <form method="post" action="{{ route('profile.update') }}">
                        ...
                        <div class="form-group">
                            ...
                            <select id="theme_color" name="theme_color">
                                <option value="cyan" {{ old('theme_color', $user->theme_color) == 'cyan' ? 'selected' : '' }}>
                                    Cyan</option>
                                <option value="pink" {{ old('theme_color', $user->theme_color) == 'pink' ? 'selected' : '' }}>
                                    Pink</option>
                        ...
                        @if (session('status') === 'profile-updated')
                            <span
                                style="color: #0f8; font-family: var(--font-mono); font-size: 0.8rem; margin-left: 15px;">Updated
                                Successfully.</span>
                        @endif
                    </form>
                </div>
                ...
                <div class="settings-panel">
                    ...
                    <form method="post" action="{{ route('password.update') }}">
                        ...
                        <div class="form-group">
                            ...
                            @error('current_password', 'updatePassword')<div class="form-error">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            @error('password_confirmation', 'updatePassword')<div class="form-error">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        @if (session('status') === 'password-updated')
                            <span
                                style="color: #0f8; font-family: var(--font-mono); font-size: 0.8rem; margin-left: 15px;">Security
                                Updated.</span>
                        @endif
                    </form>
                </div>
