...
<section id="hero">
  ...
  <div class="hero-content">
    ...
    <div class="hero-btns">
      <a href="cafe.html" class="btn btn-solid">⬡ Enter Café</a>
      <a href="study.html" class="btn btn-cyan">◈ Join Study Room</a>
      <a href="barista.html" class="btn btn-purple">◆ Talk to AI Barista</a>
    </div>
  </div>
</section>
...
<section>
  ...
  <div class="features-grid">
    <a href="study.html" class="feature-card">
    ...
    <a href="barista.html" class="feature-card purple">
      <span class="fc-icon">◆</span>
    ...
    <a href="cafe.html" class="feature-card pink">
      <span class="fc-icon">◉</span>
    ...
    <a href="profile.html" class="feature-card purple">
      <span class="fc-icon">⬡</span>
...
<section>
  ...
  <div class="tables-preview">
    ...
    <div class="table-card blue" style="border-style:dashed;opacity:0.5;cursor:pointer;" onclick="location.href='study.html'">
...
<section>
  ...
  <div style="display:grid;grid-template-columns:1fr 1fr;gap:40px;margin-top:60px;align-items:center;">
    <div>
      ...
      <a href="barista.html" class="btn btn-cyan">Open Full Chat Interface →</a>
    </div>
